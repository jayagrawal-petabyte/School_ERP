...
type NotificationDetailsNavigationProp = NativeStackNavigationProp<RootStackParamList,"NotificationDetails">;
interface Props {route: NotificationDetailsRouteProp;navigation: NotificationDetailsNavigationProp;}
...
export default function NotificationDetailsScreen({route,navigation,}: Props) {
