...
interface Props {route: HomeScreenRouteProp;navigation: HomeScreenNavigationProp;}
    ...
    const getAcademicItems = (): AcademicItem[] => {
        const baseItems: AcademicItem[] = [
...

            {
                ...
                color: "#FEE4E2",
                route:
                    role === "teacher" ? "TeacherMarksEntry" : "StudentResults",
            },
            {
                id: "6",
                title: "Results",
        ...
        if (role === "teacher") {
            ...
            return [
...

                {
                    ...
                    params: {
                        classId: "1",
                        className: "Standard - 8 - C",
                        defaultStudentName: "Sofia Morales",
                    },
                },
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <TouchableOpacity
                    ...
                    onPress={() =>
                        navigation.navigate(role === "teacher" ? "NotificationHistory" : "Notifications",)
                    }>
                ...
                <View style={styles.elearningSection}>
                    ...
                    <View style={styles.elearningBanner}>
                        ...
                        <Text style={styles.bannerDesc}>
                            Connect with your subject teachers in video
                            conferences.
                        </Text>
                        <TouchableOpacity
                            ...
                            onPress={() =>
                                Alert.alert(
                                    "E-Learning",
                                    "E-learning sessions are not scheduled today.",
                                )
                            }
                        >
